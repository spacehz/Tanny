...
export default function CollectionModal({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md m-4 max-h-[90vh] flex flex-col">
        <h2 className="text-xl font-bold p-6 border-b border-gray-200 sticky top-0 bg-white z-10">
        ...
        {/* Boutons */}
        <div className="flex justify-end space-x-2 p-4 border-t border-gray-200 sticky bottom-0 bg-white">
          <button
            type="button"
            onClick={onClose}
